        ...
        <div class="row">
            ...
            <div class="card">
                <div class="card-header">
                    <h3>Paid customer List</h3>
                    <a class="btn btn-success float-right btn-sm" target="_blank" href="{{route('paid.customers.report.pdf')}}"><i class="fa fa-download"> Dowload PDF</i></a>
